...
const recipeData = [
  {
    ...
    ingredients: [
      { itemName: "Millet Malt", quantity: 5, unit: "kg" as const, usageStage: "mash" as const, sortOrder: 0 },
      { itemName: "Rice Malt", quantity: 2.5, unit: "kg" as const, usageStage: "mash" as const, sortOrder: 1 },
      { itemName: "Cascade Hops", quantity: 30, unit: "g" as const, usageStage: "boil" as const, useTimeMinutes: 60, sortOrder: 2 },
      { itemName: "Citra Hops", quantity: 20, unit: "g" as const, usageStage: "boil" as const, useTimeMinutes: 15, sortOrder: 3 },
      ...
      { itemName: "Safale US-05", quantity: 1, unit: "each" as const, usageStage: "ferment" as const, sortOrder: 5 },
      { itemName: "Clarity Ferm", quantity: 10, unit: "ml" as const, usageStage: "ferment" as const, sortOrder: 6 },
    ],
  },
  {
    name: "GF Session IPA",
    ...
    ingredients: [
      { itemName: "Millet Malt", quantity: 4, unit: "kg" as const, usageStage: "mash" as const, sortOrder: 0 },
      { itemName: "Rice Malt", quantity: 2, unit: "kg" as const, usageStage: "mash" as const, sortOrder: 1 },
      { itemName: "Galaxy Hops", quantity: 25, unit: "g" as const, usageStage: "boil" as const, useTimeMinutes: 60, sortOrder: 2 },
      { itemName: "Galaxy Hops", quantity: 40, unit: "g" as const, usageStage: "whirlpool" as const, useTimeMinutes: 20, sortOrder: 3 },
  ...
  },
  {
    ...
    ingredients: [
      { itemName: "Millet Malt", quantity: 5.5, unit: "kg" as const, usageStage: "mash" as const, sortOrder: 0 },
      { itemName: "Rice Malt", quantity: 3, unit: "kg" as const, usageStage: "mash" as const, sortOrder: 1 },
      { itemName: "Cascade Hops", quantity: 20, unit: "g" as const, usageStage: "boil" as const, useTimeMinutes: 60, sortOrder: 2 },
      { itemName: "Safale US-05", quantity: 1, unit: "each" as const, usageStage: "ferment" as const, sortOrder: 3 },
      { itemName: "Clarity Ferm", quantity: 10, unit: "ml" as const, usageStage: "ferment" as const, sortOrder: 4 },
      { itemName: "Gypsum (CaSO4)", quantity: 5, unit: "g" as const, usageStage: "mash" as const, sortOrder: 5 },
    ],
  },
];
