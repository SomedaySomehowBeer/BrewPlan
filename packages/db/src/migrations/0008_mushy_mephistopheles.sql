...
CREATE TABLE `__new_finished_goods_stock` (
	...
	CONSTRAINT "fg_qty_reserved_lte_on_hand" CHECK("__new_finished_goods_stock"."quantity_reserved" <= "__new_finished_goods_stock"."quantity_on_hand")
);
...
CREATE TABLE `__new_purchase_order_lines` (
	...
	CONSTRAINT "pol_qty_received_lte_ordered" CHECK("__new_purchase_order_lines"."quantity_received" <= "__new_purchase_order_lines"."quantity_ordered")
);
--> statement-breakpoint
